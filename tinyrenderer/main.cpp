...
Vec3f getBarycentric(std::vector<std::array<double,3>> &triangle, double *point) {
    Vec3f AB(triangle[1][0] - triangle[0][0], triangle[1][1] - triangle[0][1], triangle[1][2] - triangle[0][2]);
    Vec3f AC(triangle[2][0] - triangle[0][0], triangle[2][1] - triangle[0][1], triangle[2][2] - triangle[0][2]);
    Vec3f AP(point[0] - triangle[0][0], point[1] - triangle[0][1], point[2] - triangle[0][2]);
